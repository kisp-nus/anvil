...
property ack_low_when_valid_high (state_curr_0, valid_0, ack_0);
    @(posedge clk_i) ((state_curr_0==WAIT_ACK) |-> valid_0 && !ack_0);
endproperty
...
property data_stable_N_cycles_after_ack_high (state_curr_0, counter_0, data_0);
